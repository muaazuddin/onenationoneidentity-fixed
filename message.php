...
<?php
    ...
    include('session.php');
    $id=$_GET['id'];
    $query = mysqli_query($conn,"SELECT * from person where person.nid ='$id'");
    $senderinfo_row=mysqli_fetch_array($query);
    $query2 = mysqli_query($conn,"SELECT * from person where person.nid ='$user_id'");
    $userinfo_row=mysqli_fetch_array($query2);
...
<div id="frame">
	<div id="sidepanel">
		<div id="profile">
			<div class="wrap">
				...
				<p><?php echo $userinfo_row['name']; ?></p>				
			</div>
		</div>
      ...
      <?php
        ...
        while($patient_row = mysqli_fetch_array($query)){
          ...
          $query2 = mysqli_query($conn,"SELECT * from person inner join message on person.nid = message.d_nid where person.nid ='$d_nid'");
          $dnid_row=mysqli_fetch_array($query2);
        
          
      ?>
			
				<li class="contact">
          <a style="text-decoration:none;" href="message.php<?php echo '?id='.$d_nid; ?>">
					<div class="wrap">
						<span class="contact-status online"></span>
						<!-- <img src="http://emilcarlsson.se/assets/louislitt.png" alt="" /> -->
            <img src="img/<?php echo $dnid_row['image'] ?>" class="box">

						<div class="meta">
							<p class="name"><?php echo $dnid_row['name']; ?> </p>
      ...
      <?php
        ...
        while($doctor_row = mysqli_fetch_array($query)){
          ...
          $query2 = mysqli_query($conn,"SELECT * from person inner join message on person.nid = message.p_nid where person.nid ='$p_nid'");
          $pnid_row=mysqli_fetch_array($query2);
      ?>
      <ul>
				<li class="contact">
        <a style="text-decoration:none;" href="message.php<?php echo '?id='.$p_nid; ?>">
					<div class="wrap">
						<span class="contact-status online"></span>
            <img src="img/<?php echo $pnid_row['image'] ?>" class="box">
						<div class="meta">
							<p class="name"><?php echo $pnid_row['name']; ?></p>
							<!-- <p class="preview">You just got LITT up, Mike.</p> -->
						</div>
					</div>
        </a>
  ...
  <?php if($id != '0'){?>
		<div class="contact-profile">
			...
			<p><?php echo $senderinfo_row['name']; ?></p>
      ...
      <?php if($id != '0'){?>
        <div class="wrap">
          <form action="#" class="typing-area">
            <input type="text" class="usertype" name="usertype" value="<?php echo $user_type; ?>" hidden>
            <input type="text" class="incoming_id" name="incoming_id" value="<?php echo $user_id; ?>" hidden>
            <input type="text" class="outgoing_id" name="outgoing_id" value="<?php echo $id; ?>" hidden>
