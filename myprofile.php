          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="na1">
              ...
              <a class="nav-link" href="myprofile.php?id=<?php echo $user_id; ?>">
                <div class="divm">
                  <p><div class="divname" style="font-size: 12p; font-weight: 500 !important;color: #000 !important; ">
                    <?php echo $my['name']; ?>
                  </div></p>
                  <p>
                  <div class="divid" style="font-size: 7px; font-weight: 500 !important;color: #000 !important; ">
                  <?php echo $my['nid']; ?>
                  </div>
                  </p>
                </div>
