...
<style>
  .dashboard-container {
        ...
        .appointments ul, .prescriptions ul, .messages ul, .notifications ul {
            list-style: none;
            padding: 0;
        }
        .appointments ul li, .prescriptions ul li, .messages ul li, .notifications ul li {
        ...
        .appointments ul li:hover, .prescriptions ul li:hover, .messages ul li:hover, .notifications ul li:hover {
    ...
    <div class="dashboard-container">
        ...
        <div class="dashboard-sections">
            ...
            <div class="dashboard-section profile-overview">
                ...
                <img src="img/doctor1.jpg" alt="Profile Picture">
                <p>Name: John Doe</p>
                <p>Age: 30</p>
                <p>Blood Type: O+</p>
                <p>Health ID: 123456</p>
                <a href="#" class="btn">Edit Profile</a>
            </div>

            <!-- Appointment History Section -->
            <div class="dashboard-section appointments">
                <h2>Appointment History</h2>
                <ul>
                    <li>Dr. Smith - 2024/08/12 - Checkup</li>
                    <li>Dr. Adams - 2024/07/30 - Dental Cleaning</li>
                    <li>Dr. Kelly - 2024/06/25 - Eye Exam</li>
                </ul>
                <a href="#" class="btn">View All Appointments</a>
            </div>

            <!-- Prescription Section -->
            <div class="dashboard-section prescriptions">
                <h2>Prescriptions</h2>
                <ul>
                    <li>Aspirin - 50mg</li>
                ...
                <a href="#" class="btn">View All Prescriptions</a>
            </div>
            ...
            <div class="dashboard-section messages">
                ...
                <ul>
                    ...
                    <li>Reminder: Annual check-up due</li>
                    <li>Lab results available</li>
                </ul>
                <a href="#" class="btn">View All Messages</a>
            </div>
            ...
            <div class="dashboard-section notifications">
                <h2>Notifications</h2>
                <ul>
                    <li>Appointment with Dr. Smith on 2024/08/12</li>
                    <li>New lab results uploaded</li>
                    <li>Time for your daily medication</li>
                </ul>
