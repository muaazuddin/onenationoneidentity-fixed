            ...
            <div class="col-xl-10 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h2 class="mb-0"><i class="fas fa-user-injured me-2"></i>Register New Patient</h2>
                    </div>
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 mb-3">
                                    <label for="nid" class="form-label required-field">National ID (NID)</label>
                            ...
                            <div class="text-center mt-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-plus-circle me-2"></i> Register Patient
                                </button>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            passwordInput.addEventListener('input', function() {
                ...
                const strengthColors = ['#dc3545', '#ffc107', '#ff9800', '#4caf50', '#2e7d32'];
