          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="na1">
              ...
              <a class="nav-link" href="myprofile.php?id=<?php echo $user_id; ?>">
                <div class="divm">
                  <div class="divname" style="font-size: 12p; font-weight: 500;color: #000; ">
                    <?php echo $my['name']; ?>
                  </div>
            ...
            <?php
                ...
                $query = mysqli_query($conn,"
                  SELECT 
                      ...
                      person.image 
                  FROM doctor 
                  INNER JOIN person ON person.nid = doctor.d_nid 
                  INNER JOIN dmdc ON dmdc.dmdc_id = doctor.dmdc_id  
                  LEFT JOIN reviewfordoctor ON reviewfordoctor.d_nid = doctor.d_nid 
                  WHERE doctor.d_nid != '$user_id' 
                  GROUP BY doctor.d_nid, person.name, doctor.specialist, person.image 
